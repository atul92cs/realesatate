...
class DbOperation
{
  ...
  {
      $stmt=$this->con->prepare("SELECT project_id,project_name,project_type,possesion_type,project_price,project_address FROM projects WHERE project_prior = 'featured'");
	  $stmt->execute();
